...
if __name__ == "__main__":
    ...
    dkist_vbi_target_header.tofile("/cluster/scratch/zhuyin/pid_1_123_aux/plot_ready/dkist_target_wcs_header_before_crop.fits", overwrite=True)
    ...
    file_Halpha_destretched = h5py.File("/cluster/scratch/zhuyin/pid_1_123/BLZNL_aligned/BLZNL_aligned_all.h5")
    Halpha_dset = file_Halpha_destretched["vbi_img"]
    Halpha_da = da.from_array(Halpha_dset, chunks=(1, 4096, 4096))
    Halpha_dset_raw = dkist.load_dataset("/cluster/scratch/zhuyin/pid_1_123/BLZNL")
    ...
    file_Hbeta_destretched = h5py.File("/cluster/scratch/zhuyin/pid_1_123/BJOLO_aligned/BJOLO_aligned_all.h5")
    Hbeta_dset = file_Hbeta_destretched["vbi_img"]
    Hbeta_da = da.from_array(Hbeta_dset, chunks=(1, 4096, 4096))

    Hbeta_dset_raw = dkist.load_dataset("/cluster/scratch/zhuyin/pid_1_123/BJOLO")

    # load destretched VBI-B Ca II K dataset
    # no change to pointing because it is difficult to coalign Ca II K 

    file_CaIIK_destretched = h5py.File("/cluster/scratch/zhuyin/pid_1_123/BZPOW_aligned/BZPOW_aligned_all.h5")
    CaIIK_dset = file_CaIIK_destretched["vbi_img"]
    CaIIK_da = da.from_array(CaIIK_dset, chunks=(1, 4096, 4096))

    CaIIK_dset_raw = dkist.load_dataset("/cluster/scratch/zhuyin/pid_1_123/BZPOW")
    ...
    if todo_list["Gband"]:
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Gband_AEZDV_pr.hdf5","w") as hf:
    ...
    if todo_list["CaIIK"]:
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/CaIIK_BZPOW_pr.hdf5","w") as hf:
    ...
    if todo_list["Hbeta"]:
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Hbeta_BJOLO_pr.hdf5","w") as hf:
    ...
    if todo_list["Halpha"]:
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Halpha_BLZNL_pr.hdf5","w") as hf:
    ...
    if todo_list["TiO"]:
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/TiO_BNRPZ_pr.hdf5","w") as hf:
    ...
    if todo_list["HRIEUV"]:
        eui_files = sorted(glob("/cluster/home/zhuyin/scratch/pid_1_123_aux/HRI/coalign_step_boxcar/*.fits"))
        ...
        eui_map_wcs.to_header().tofile("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/hri_nocrop_noproj_wcs.fits",
                                        overwrite=True)
        ...
        np.save("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/hrieuv_no_proj_extent.npy", hrieuv_no_proj_extent)
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/HRIEUV_pr.hdf5","w") as hf:
    ...
    if todo_list["IRISSJI"]:
        ...
        iris_sji_1400_cube = read_iris_sji("/cluster/scratch/zhuyin/pid_1_123_aux/IRIS/iris_l2_20221024_190447_3643101203_SJI_1400_t000.fits",
                                        sdo_rsun=False)
        
        n_iris_sji_1400 = len(iris_sji_1400_cube)
        
        with ProcessPoolExecutor(max_workers=max_workers) as executor:
            results_irissji_1400 = list(executor.map(job_irissji_wow_and_reproject, iris_sji_1400_cube,
            [sji_map_.wcs for sji_map_ in iris_sji_1400_cube], [dkist_vbi_target_cube_crop_rebin.wcs]*n_iris_sji_1400))
    ...
    if todo_list["AIA"]:
        ...
        aia_171_cube = sunpy.map.Map(sorted(glob("/cluster/scratch/zhuyin/pid_1_123_aux/AIA/171/*.fits"))[:],sequence=False,
                                    memmap=True)
        ...
        with h5py.File("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/AIA_171_pr.hdf5","w") as hf:
        ...
        aia_171_date_obs_table.write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/AIA_171_date_obs.txt",
                                    format="ascii", overwrite=True)
    ...
    if todo_list["VBI_DATE_OBS"]:
        Gband_dset_raw.headers[["DATE-AVG",]].write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Gband_AEZDV_date_avg.txt",
                                                    format="ascii", overwrite=True)
        Hbeta_dset_raw.headers[["DATE-AVG",]].write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Hbeta_BJOLO_date_avg.txt",
                                                    format="ascii", overwrite=True)
        CaIIK_dset_raw.headers[["DATE-AVG",]].write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/CaIIK_BZPOW_date_avg.txt",
                                                    format="ascii", overwrite=True)
        TiO_dset_raw.headers[["DATE-AVG",]].write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/TiO_BNRPZ_date_avg.txt",
                                                    format="ascii", overwrite=True)
        Halpha_dset_raw.headers[["DATE-AVG",]].write("/cluster/home/zhuyin/scratch/pid_1_123_aux/plot_ready/Halpha_BLZNL_date_avg.txt",
                                                    format="ascii", overwrite=True)
